...
- [Variable-energy S-parameter extraction](./examples/db%20spectrum%20examples/variable_energy_measurement_parameter_extraction.ipynb) — S-parameter vs implantation energy
...
**VEDB Fitting**
- [Simulation example](./examples/diffusion%20length%20optimization/simulation%20-%20diffusion%20length%20optimization%20example.ipynb) — simulate VEDB data and recover diffusion lengths
- [Measurement example](./examples/diffusion%20length%20optimization/measurements%20-%20diffusion%20length%20optimization%20example.ipynb) — fit experimental VEDB measurements

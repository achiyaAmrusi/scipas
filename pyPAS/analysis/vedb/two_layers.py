...
class TwoBulkDiffusionLengthOptimization:
    """
    Optimize the bulk positron diffusion length of a two-layer model
    ...
    The class uses:
        ...
        3. A two-layer initial model as a starting guess.
    ...
    def make_sample(self, diffusion_length_0, diffusion_length_1):
        """
        Construct a simplified two-layer model for a given diffusion length.
    ...
    def optimize_diffusion_length(self, bounds=None):
        """
        Optimize the diffusion length for a two-layer model.
